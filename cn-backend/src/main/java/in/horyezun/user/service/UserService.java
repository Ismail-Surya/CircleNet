...
public class UserService {
	...
	private UserProfileResponse mapToProfileResponse(User user) {
		return new UserProfileResponse(user.getId(), user.getUsername(), user.getEmail(), user.getFirstName(),
				user.getLastName(), user.getProfilePictureUrl(), user.getBio(), user.getCreatedAt(),
				user.getUpdatedAt());
	}
	...
	public PublicProfileResponse getPublicProfile(String username) {
		...
		return new PublicProfileResponse(user.getUsername(), user.getFirstName(), user.getLastName(),
				user.getProfilePictureUrl(), user.getBio(), user.getCreatedAt());
	}
